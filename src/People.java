...
public class People {
    ...
    String race, String hairColor, String eyeColor, String description, ArrayList<String> tattoos, double shoeSize, ArrayList<String> piercings, boolean inJail)
    {
        if(haveCriminal(firstName + " " + lastName))
            return false;
        criminalList.add(new Criminal(firstName, lastName, age, sex, nickname, height, weight, race, hairColor, eyeColor, description, tattoos, shoeSize, piercings, inJail));
        return true;
    }
     ...
     */
    public boolean addVictim(String firstName, String lastName, int age, String sex, String report, String hospital, long phoneNum, String address)
    {
     ...
     */
    public boolean addOfficer(String firstName, String lastName, int age, String sex, String rank, long officeNum, String address, String city)
    {
     ...
     */
    public boolean addWitness(String firstName, String lastName, int age, String sex, String testimony, long phoneNum, String address)
    {
