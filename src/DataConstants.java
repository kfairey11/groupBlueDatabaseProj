...
public abstract class DataConstants {
    ...
    protected final static String CRIMINAL_FILE_NAME = ".json/Criminals.json";
    ...
    protected final static String VICTIM_FILE_NAME = ".json/Victim.json";
    ...
    protected final static String OFFICER_FILE_NAME = ".json/Officer.json";
    ...
    protected final static String WITNESS_FILE_NAME = ".json/Witness.json";
    ...
    protected final static String CASE_FILE_NAME = ".json/Case.json";
